...
(function(){
 ...
 function classify(k,o){
  ...
  if(/アレル|ヒスタミン|ザイザル|レボセチリ|ジルテック|セチリジン|アレグラ|フェキソ|アレロック|オロパタ|パタノール|アレジオン|エピナスチン|クラリチン|ロラタジン|デザレックス|デスロラタ|ルパフィン|ルパタジン|ザジテン|ケトチフェン|オノン|プランルカスト|キプレス|シングレア|モンテルカスト|ゼスラン|メキタジン|ニポラジン|クレマスチン|ペリアクチン|シプロヘプタジン|エバスチン|エバステル|クロモグリク|インタール|セレスタミン/.test(s))return '抗アレルギー薬';
  if(/ムコダイン|カルボシステイン|ムコソルバン|アンブロキソール|アスベリン|チペピジン|アストミン|ジメモルファン|デキストロメトルファン|メジコン|メプチン|プロカテロール|テオドール|テオフィリン|ホクナリン|ツロブテロール|ベネトリン|サルブタモール|フスコデ|鎮咳|去痰|気管支|吸入/.test(s))return '呼吸器・鎮咳去痰';
  if(/カロナール|アセトアミノフェン|アンヒバ|アルピニー|トランサミン|トラネキサム|解熱|鎮痛|抗炎症/.test(s))return '解熱鎮痛・抗炎症';
  if(/ナウゼリン|ドンペリドン|プリンペラン|メトクロプラミド|モビコール|マクロゴール|ミヤBM|ビオフェルミン|ラックビー|整腸|乳酸菌|酸化マグネシウム|マグミット|便秘|エソメプラゾール|ネキシウム|テプレノン|セルベックス|タンニン酸アルブミン|テレミン|ビサコジル|消化器/.test(s))return '消化器';
