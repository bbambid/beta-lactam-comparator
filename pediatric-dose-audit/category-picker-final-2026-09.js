...
(function(){
 ...
 function classify(k,o){
  ...
  const s=blob(k,o);
  if(/プレドニ|プレドニン|リンデロン|ベタメタ|デキサメタ|デカドロン|ステロイド|副腎皮質/.test(s))return 'ステロイド';
  if(/葛根湯|麻黄湯|小青竜湯|五苓散|麦門冬湯|柴胡|漢方|ツムラ|クラシエ/.test(s))return '漢方';
  if(/アシクロ|ゾビラックス|バラシクロ|バルトレックス|オセルタ|タミフル|ラニナ|イナビル|ザナミ|リレンザ|バロキサ|ゾフルーザ|抗ウイルス/.test(s))return '抗ウイルス薬';
  ...
  if(/アレル|ヒスタミン|ザイザル|レボセチリ|ジルテック|セチリジン|アレグラ|フェキソ|アレロック|オロパタ|アレジオン|エピナスチン|クラリチン|ロラタジン|デザレックス|デスロラタ|ルパフィン|ルパタジン|ザジテン|ケトチフェン|オノン|プランルカスト|キプレス|シングレア|モンテルカスト|ゼスラン|メキタジン|クレマスチン|ペリアクチン|シプロヘプタジン/.test(s))return '抗アレルギー薬';
  ...
  if(/ナウゼリン|ドンペリドン|プリンペラン|メトクロプラミド|モビコール|マクロゴール|ミヤBM|ビオフェルミン|ラックビー|整腸|乳酸菌|酸化マグネシウム|マグミット|便秘|消化器/.test(s))return '消化器';
